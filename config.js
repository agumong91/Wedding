...
// ── 배경 음악 ──
  ...
  story: {
    ...
    // 신랑 소개 (images/groom/ 사진과 함께 표시, 사진이 없으면 챕터 자체가 숨겨집니다)
    groom: {
      title: "신랑 이야기",
      text: "장난기 많지만 다정한 사람입니다.\n무엇이든 함께 나누고 싶어하는\n든든한 사람이에요."
    },

    // 신부 소개 (images/bride/ 사진과 함께 표시, 사진이 없으면 챕터 자체가 숨겨집니다)
    bride: {
      title: "신부 이야기",
      text: "잔잔하지만 단단한 사람입니다.\n누구보다 따뜻한 마음을 가진\n사람이에요."
    },

    // 커플 사진 챕터 제목 (images/story/ 사진과 함께 표시)
    together: {
      title: "그렇게, 우리가 되었습니다"
    }
  },
