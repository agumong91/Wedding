...
// ── 배경 음악 ──
  ...
  greeting: {
    title: "소중한 분들을 초대합니다",
    content: "서로에게 가장 편안한 쉼터가 되어\n이제 평생의 보금자리를 함께 지어갑니다.\n\n저희 두 사람의 첫 출발을\n따뜻한 온기로 축복해 주세요."
  },

  // ── 우리의 이야기 (신랑 → 신부 → 우리, 함께 순서로 자연스럽게 전개) ──
  story: {
    title: "Home, Sweet Home",
    content: "하루의 끝에 늘 서로가 있었습니다.\n언제든 돌아와 쉴 수 있는 다정한 집이 되어\n평생을 함께하기로 약속합니다.",

    // 신랑 소개 (신부가 바라본 신랑, images/groom/ 사진과 함께 표시, 사진이 없으면 챕터 자체가 숨겨집니다)
    groom: {
      title: "언제나 기댈 수 있는 든든한 나무, 지원",
      text: "어떤 순간에도 묵묵하고 단단하게 곁을 지키며,\n존재만으로도 깊은 안도감을 주는 사람입니다."
    },

    // 신부 소개 (신랑이 바라본 신부, images/bride/ 사진과 함께 표시, 사진이 없으면 챕터 자체가 숨겨집니다)
    bride: {
      title: "마음을 밝혀주는 다정한 온기, 유정",
      text: "지친 하루의 끝에 늘 따뜻한 미소를 건네며,\n존재만으로도 마음을 편안하게 해주는 사람입니다."
    },

    // 커플 사진 챕터 (사진 1장과 함께 깔끔하게 제목만 노출, images/story/ 사진과 함께 표시)
    together: {
      title: "서로에게 가장 다정한 집이 된 순간"
    }
  },
  ...
  accounts: {
    groom: [
      ...
      { role: "아버지", name: "이형복", bank: "시티뱅크", number: "120735-78261" },      
      { role: "어머니", name: "조현주", bank: "국민은행", number: "060-21-0473-622" }
    ],
    bride: [
      { role: "신부", name: "이유정", bank: "하나은행", number: "2579-107-0744207" },
      { role: "아버지", name: "이명환", bank: "농협은행", number: "3510384278193" },
      { role: "어머니", name: "박은주", bank: "하나은행", number: "24089090339607" }
    ]
  },
