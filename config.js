...
// ── 인사말 ──
  greeting: {
    title: "소중한 분들을 초대합니다",
    content: "서로에게 가장 편안한 쉼터가 되어\n이제 평생의 보금자리를 함께 지어가려 합니다.\n\n저희 두 사람의 첫 출발을\n따뜻한 온기로 축복해 주세요."
  },

  // ── 우리의 이야기 ──
  story: {
    title: "Home, Sweet Home",
    content: "각자의 하루 끝에 늘 서로가 있었습니다.\n언제든 돌아와 쉴 수 있는 다정한 집이 되어\n평생을 함께하기로 약속합니다.",

    // 신랑 소개 (신부가 바라본 신랑)
    groom: {
      title: "언제나 기댈 수 있는 큰 나무",
      text: "늘 묵묵하고 든든하게 곁을 지켜주는 사람.\n함께 있으면 어떤 폭풍우도 지나갈 것 같은\n가장 안전한 쉼터가 되어주는 사람입니다."
    },

    // 신부 소개 (신랑이 바라본 신부)
    bride: {
      title: "마음을 밝혀주는 다정한 온기",
      text: "지친 하루의 끝에 늘 따뜻한 미소를 건네는 사람.\n존재만으로도 마음을 편안하게 물들이는\n가장 사랑스러운 햇살 같은 사람입니다."
    },

    // 커플 사진 챕터 제목
    together: {
      title: "서로가 서로의 집이 된 순간들"
    }
  },
  ...
  meta: {
    title: "지원❤유정 결혼합니다.",
    description: "서로 다른 길을 걷던 두 사람이\n이제 함께 걷습니다. 귀한 발걸음으로 축복해주세요."
  }
};
